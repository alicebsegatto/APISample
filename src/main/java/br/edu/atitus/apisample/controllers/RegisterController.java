...
public class RegisterController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<RegisterEntity> getOneRegister(@PathVariable(name= "id") UUID id) throws Exception {
		var register = service.findById(id);
		return ResponseEntity.ok(register);
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<RegisterEntity> putRegister(@PathVariable(name= "id") UUID id, @RequestBody RegisterDTO dto) throws Exception {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<String> deleteRegister(@PathVariable(name= "id") UUID id) throws Exception {
